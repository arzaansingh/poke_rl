"""
V4 Grid Search — Statistical Analysis
=======================================
Comprehensive statistical analysis of the 2x2 factorial experiment
...
def run_full_analysis(combo_ids):
    ...
    print("\n" + "=" * 100)
    print("  V4 GRID SEARCH — STATISTICAL ANALYSIS")
    print("=" * 100)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="V4 Grid Search — Statistical Analysis")
