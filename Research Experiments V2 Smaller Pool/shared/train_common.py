...
async def run_training(player_class, args, model_dir):
    ...
    # Team builders with deterministic seeds
    opp_team_seed = args.seed + 1000
    learner_team_seed = args.seed + 2000
    ...
    opponent = OppClass(
        ...
        team=Gen4OUPoolTeambuilder(seed=opp_team_seed),
    )
    ...
    learner = LearnerClass(
        ...
        team=Gen4OUPoolTeambuilder(seed=learner_team_seed),
    )
