...
from shared.config import (
    ...
    ALPHA, GAMMA, LAMBDA, get_epsilon
)
...
async def run_training(player_class, args, model_dir):
    ...
    if args.historic_battles == 0:
        print(f"--- {player_class.__name__} Run {args.run_id} (Batch: {args.batch_size}, Eps: {get_epsilon(0):.3f}) ---")
    ...
    while battles_collected < args.batch_size:
        try:
            ...
            # UPDATE EPSILON FOR EVERY BATTLE
            learner.epsilon = get_epsilon(battle_idx)
